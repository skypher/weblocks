...
(defslotmethod render-data-value (obj slot-name (slot-type (eql 'boolean)) (slot-value (eql nil))
...
(defslotmethod render-form-value (obj slot-name (slot-type (eql 'boolean)) slot-value &rest
